...
void QmlWindow::addLibsDirectory(const QString &dirName)
{
...
void QmlWindow::_requestUpdate() { if ( ! _renderTimer.isActive() ) { _renderTimer.start(); } }
...
void QmlWindow::libs(const QString &dirname)
{
	_qmlEngine->addImportPath(dirname);
}
