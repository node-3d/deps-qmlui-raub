...
Qt::Key keyconv(int from) {
	...
	switch (from) {
		...
		REPLACE(103, Qt::Key_Home)
		REPLACE(97, Qt::Key_End)
		REPLACE(100, Qt::Key_Left)
		REPLACE(104, Qt::Key_Up)
		REPLACE(102, Qt::Key_Right)
		REPLACE(98, Qt::Key_Down)
		REPLACE(105, Qt::Key_PageUp)
		REPLACE(99, Qt::Key_PageDown)
